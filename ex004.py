...
print('É uma palavra/letra? - {}'.format(algo.isalpha()))
print('É alfanumérico? - {}'.format(algo.isalnum()))
print('Está apenas em letras minúsculas? - {}'.format(algo.islower()))
print('Está apenas em letras maiúsculas? - {}'.format(algo.isupper()))
